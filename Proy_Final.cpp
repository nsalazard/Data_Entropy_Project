...
void evolve(vector & data, vector & prob, int Np, int N, int nsteps,double Xmin,double Ymin,double DELTA,int Npart,int u);
...
int main(int argc, char **argv)
{
  ...
  cream_in_coffee(potential, N, lmin,lmax, DELTA);
    ...
    // evolve and print
  evolve(potential,prob,Np, N, NSTEPS, Xmin, Ymin, DELTA,Npart,u);
...
void start_gnuplot(double Xmin,double Ymin)
{
    ...
    std::cout << "set output 'Entropy_istep.gif'\n";
